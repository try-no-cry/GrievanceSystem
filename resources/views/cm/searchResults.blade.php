...
<div style="margin-left:20px;margin-right:20px;padding-top:10px; width:80%;">
                ...
                @foreach($grvs as $grv)
                    ...
                    <div class="panel panel-default">
                      ...
                      echo "<a  class=\"btn btn-default\" href=\"/gms1/public/c/showreport/$grv->id\" style=\"float:right;\">View Reports</a>";
                      else
                      echo "<p  style=\"float:right;margin-right:7px\"><small>No Follow-up</small></p>"; 
                      
                      ?>
                      <a class="btn btn-default" style="float:right; margin-right: 25px;" href="/gms1/public/c/show/{{$grv->id}}">View Grievance</a>
