...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
        ...
        <body>
        <h5 te> New Grievance:</h5>
        <p>

        <div class="container box" style="padding-top:5px;background-color:rgba(0,0,0,.03);border:1px solid white;border-radius:15px">
		
                <div class="headEmail" style="margin-top:12px;padding-left:10px;padding-top:5px;background-color:#e0e0e0;border:1px solid white;border-radius:15px">                <p style=""> <b>Grievance From:</b> &ensp;{{$grievance->user_email}}</p>
               
           <b> <br>Grievance Subject</b>&ensp;{{$grievance->subject}}
            <br>
            <br>
            </div>
